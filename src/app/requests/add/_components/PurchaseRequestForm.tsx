...
export function PurchaseRequestForm({ requesterName, setIsLoading }: PurchaseRequestFormProps) {
    ...
    return (
      <div className="relative">
        <Card className="max-w-xl mx-auto shadow-lg border-primary/20 rounded-2xl">
          <div className="pt-6" />
          <CardContent className="pt-0 pb-8 px-2 sm:px-8 space-y-8">
  ...
  return (
    <div className="relative">
      <Card className="max-w-xl mx-auto shadow-lg border-primary/20 rounded-2xl">
        <CardContent className="pt-0 pb-8 px-2 sm:px-8">
          <Form {...form}>
                ...
                {fields.map((item, idx) => (
                  <div key={item.id} className="grid grid-cols-1 sm:grid-cols-[2fr_1fr_1fr_2fr_auto] gap-4 items-end border-b pb-4 last:border-b-0 last:pb-0">
                    <FormField
                      ...
                      render={({ field }) => (
                        <FormItem className="w-full">
                          <FormLabel htmlFor={`productName-${idx}`}>Produto</FormLabel>
                          <div className="relative">
                    ...
                    <FormField
                      ...
                      render={({ field }) => (
                        <FormItem className="w-full">
                          <FormLabel htmlFor={`quantity-${idx}`}>Qtd.</FormLabel>
                          <div className="relative">
                    ...
                    <FormField
                      ...
                      render={({ field }) => (
                        <FormItem className="w-full">
                          <FormLabel htmlFor={`unitPrice-${idx}`}>Preço Unitário</FormLabel>
                          <div className="relative">
                            <DollarSign className="absolute left-3 top-1/2 -translate-y-1/2 w-4 h-4 text-muted-foreground" />
                            <NumericFormat
                              id={`unitPrice-${idx}`}
                              className="pl-10 w-full text-base input"
                              thousandSeparator
                              prefix="R$ "
                              decimalScale={2}
                              fixedDecimalScale
                    ...
                    <FormField
                      ...
                      render={({ field }) => (
                        <FormItem className="w-full">
                          <FormLabel htmlFor={`supplier-${idx}`}>Fornecedor</FormLabel>
                          <div className="relative">
